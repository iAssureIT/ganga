...
import $ 				 	from 'jquery';
import ProductCollage 		from "../../blocks/ProductCollage/ProductCollageEcommerce.js";
	...
	render() {
		...
		return (
			<div className="col-lg-12 col-md-12 col-sm-12 col-xs-12 marginTop180 mb50 ">
					<div className="row">
						<div className="col-lg-12 col-md-12 col-sm-12 col-xs-12  backColorGG">
							...
							<div className="col-lg-9 col-md-9 col-sm-12 col-xs-12 boxBorder backColorWhite mt20 mb20">
								<div className="row">
									...
									<div className="col-lg-12 col-md-12 col-sm-12 col-xs-12 mb20">
										<ProductCollage products={this.state.products}/> 
									</div>
