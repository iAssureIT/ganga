  ...
  render(){      
    return (
        <div>
          <div>                 
              <div className="">                  
                      <div className="col-lg-12 wishlistheader mt50">
                            <div className="">
                    ...
                    <section className="content viewContent">
                      ...
                      <div className="box-body">                        
                        <div className="col-lg-8 col-lg-offset-2 col-sm-10 col-sm-offset-1 col-xs-12 col-md-12  EditUserProfileWrap boxBorder mb20">
