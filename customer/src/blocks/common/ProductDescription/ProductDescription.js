						...
						<div className="container ">
						  ...
						  <div className="tab-content borderBottom">
						    ...
						    <div id="menu2" className="tab-pane fade">
						    	...
						    	<span className="tableHead">In Stock</span>&nbsp;:&nbsp;<span className="tableHead">112 Items</span><br/>
						    	<span className="tableHead">Data Sheet</span>
						    ...
						    <div id="menu3" className="tab-pane fade writeReviewText">
						     	<i className="fa fa-pencil" aria-hidden="true"></i>&nbsp; <span data-toggle="modal" data-target="#reviewModal" >Write a review</span>	
						     		<div className="modal fade in " id="reviewModal" role="dialog">
			                          <div className="modal-dialog customWidthModal " >
		                                ...
		                                <form className="formWrapper">
		                                    ...
		                                    <div className="row"> 
		                                  		<div className=" col-lg-12 col-sm-12 col-xs-12">
			                                        <div className=" col-lg-6  col-md-6  col-sm-6 col-xs-12 mt20 displayImageReview">
			                                         ...
			                                         <div className=" col-lg-6 col-md-6 col-sm-6 col-xs-12 mt20 fnSize">
			                                         	<div className="row">
				                                         	<div className="col-lg-12 col-sm-12 col-xs-12  ">
				                                         		<div className="row">
		                                    ...
		                                    <div className="col-lg-12 col-md-12 col-sm-12 col-xs-10 mt20 borderTop">
		                                        <button className=" col-lg-2  col-md-2 col-sm-2 col-xs-2 submitButton pull-right" > Submit</button>
		                                        <button className=" col-lg-2  col-md-2 col-sm-2 col-xs-2 cancelButton pull-right" data-dismiss="modal" > Cancel</button>
		                                    </div>
                                 		</form>
			                          </div>
                        			</div>					    
