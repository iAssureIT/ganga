...
class DeliveryInitiatedOrders extends Component{
  constructor(props) {
   super(props);
    this.state = {
      "data" : [],
                  ...
                  <section className="content">
                    <div className="col-lg-12 col-md-12 col-xs-12 col-sm-12 pageContent marginBottomCSS">
                      ...
                      <div className="box-header with-border col-lg-12 col-md-12 col-xs-12 col-sm-12 NOpadding-right">
                          <h4 className="NOpadding-right"> Delivery Initiated Orders</h4>
                        </div>
...
export default connect(mapStateToProps, mapDispachToProps)(DeliveryInitiatedOrders);