													...
													}
													{
														...
														<td className="textAlignCenter">
															<span>
																...
																{this.props.editId && this.props.editId == value._id? null :<i className={"fa fa-trash redFont "+value.id} id={value.id+'-Delete'} data-toggle="modal" title="Delete" data-target={"#showDeleteModal"+(value._id).replace(/[^a-zA-Z]/g, "")}></i>}
															</span>
															<div className="modal fade col-lg-12 col-md-12 col-sm-12 col-xs-12" id={"showDeleteModal"+(value._id).replace(/[^a-zA-Z]/g, "")} role="dialog">
