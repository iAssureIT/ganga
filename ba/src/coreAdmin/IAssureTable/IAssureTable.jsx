...
class IAssureTable extends Component {
    ...
    showNextPaginationButtons(){
		...
		console.log(pageCount, addInPageCount)
		this.setState({
			valI 		: addInValI,
			pageCount 	: addInPageCount
		},()=>{
			console.log(this.state.valI, this.state.pageCount)
    ...
    showPreviousPaginationButtons(){
		...
		console.log(pageCount, subFromPageCount)
		this.setState({
			valI 		: subFromValI,
											...
											return(
												<tr key={i} className="">
													...
													<td className="textAlignCenter">
														<span>
															{this.state.tableObjects.editUrl ? <i className="fa fa-pencil" title="Edit" id={value._id} onClick={this.edit.bind(this)}></i> : null}&nbsp; &nbsp; 
