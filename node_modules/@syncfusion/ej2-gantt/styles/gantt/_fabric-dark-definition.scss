...
$connector-point-hover-color: $neutral-secondary !default;
...
$gantt-unscheduled-taskbar-background-color: rgba(darken($theme-primary, 10%), .2) !default;
...
$gantt-dialog-close-icon-hover-color: #0074cc !default;
...
$gantt-active-background: #514f4f !default;
...
$gantt-active-container-border: 0 0 0 1px $neutral-secondary inset !default;