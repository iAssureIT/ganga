...
$connector-point-hover-color: $bg-base-75 !default;
$connector-point-border-color: #000 !default;
...
$gantt-unscheduled-taskbar-background-color: rgba(darken($selection-bg, 10%), .2) !default;
...
$gantt-child-task-bar: #3e047d !default;
$gantt-child-progress-bar: #6e06f1 !default;
...
$gantt-dialog-tab-background: #6e06f1 !default;
$gantt-dialog-header-font-color: $hover-font !default;
$gantt-dialog-icon-color: $hover-font !default;
$gantt-dialog-icon-hover-color: rgba(255, 255, 255, 0.15) !default;
$gantt-dialog-close-icon-hover-color: rgba($content-font, 1) !default;
...
$gantt-tab-selection-indicator-color: $hover-font !default;
...
$gantt-table-background: #000 !default;
...
$gantt-connected-task: lighten(#3e047d, 20%) !default;
...
$gantt-active-container-border: 0 0 0 1px $border-default inset !default;