...
let Gantt = class Gantt extends Component {
    ...
    onTabAction(e) {
        ...
        e.preventDefault();
        let $target = e.target;
        let colIndex = $target.getAttribute('aria-colindex');
        ...
        if ($target.classList.contains('e-rowcell') && (nextElement && nextElement.classList.contains('e-rowcell'))) {
            ...
            if (nextElement.classList.contains('e-rowcell')) {
                if (!$target.classList.contains('e-rowcell')) {
                    this.treeGrid.grid.notify('key-pressed', e);
                    let fmodule = getValue('focusModule', this.treeGrid.grid);
    ...
    getNextRowElement(rowIndex, isTab, isChartRow) {
        let expandedRecords = this.getExpandedRecords(this.currentViewData);
        let currentItem = this.currentViewData[rowIndex];
        ...
        let nextRowIndex = this.currentViewData.indexOf(nextRecord);
        if (nextRecord) {
