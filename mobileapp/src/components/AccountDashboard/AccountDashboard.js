              ...
              <ScrollView contentContainerStyle={styles.container} keyboardShouldPersistTaps="handled" >
                <View style={{paddingHorizontal:15,marginBottom:'20%'}}>
                  ...
                  <View style={{backgroundColor:'#fff',marginTop:0,marginBottom:15,marginTop:15}}>
                    ...
                    <Text style={{paddingHorizontal:18,fontSize:13,fontFamily:"Montserrat-SemiBold",textAlign:'center',paddingVertical:10,marginTop:15,backgroundColor:'#f1f1f1',borderWidth:1,borderColor:'#f1f1f1',}}>Contact Information</Text>
                    </View>
                    ...
                    <Text style={{fontSize:12,fontFamily:"Montserrat-Regular",color:'#666',flexWrap:'wrap'}}> 323 Amanora Chambers, Amanora Mall,Hadapsar,Pune,411028 Maharashtra uygfewuafyrfuyeuwefegfuyegfuwgefwyegfyuwegfyugewfyuwe jhfjwfwegfw hfuwehuiwef efwfuwehfuw</Text> 
